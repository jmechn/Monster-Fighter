...
public class WinScreen extends JFrame {
	 ...
	 * Create the frame.
	 */
	public WinScreen(Game game, MainInventory inventory, PikimonTeam pikimonTeam, Battle battle,
			ItemsForSale shop){
		...
		coinIcon.setIcon(new ImageIcon(WinScreen.class.getResource("/images/icons/coin.png")));
		...
		bagelIcon.setIcon(new ImageIcon(WinScreen.class.getResource("/images/icons/bagelv2.png")));
		...
		JLabel lblNewLabel = new JLabel(String.format("%s YOU WON =D", game.getName()));
		...
		background.setIcon(new ImageIcon(WinScreen.class.getResource(String.format("%s", game.setBackground()))));
